...
if __name__ == '__main__':
    ...
    story = (
    "Piranhas are more " + ad + " during the day, so cross the river at\n"
    "night. Piranhas are attracted to fresh " + li + " and will most\n"
    "likely take a bite out of your " + bo + " if you " + ve + ". Whatever\n"
    "you do, if you have an open wound, try to find another way to get "
    "back to the " + pl + ". Good luck!"
    )
